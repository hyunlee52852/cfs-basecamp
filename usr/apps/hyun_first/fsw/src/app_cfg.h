...
**
**  Purpose:
**    Define configurations for the Hyun_first application
**
**  Notes:
...
**      a deployment then the definition of the HYUN_FIRST_REV
**      macro in hyun_first_platform_cfg.h should be updated.
**
*/
#ifndef _app_cfg_
#define _app_cfg_
...
#include "app_c_fw.h"
#include "hyun_first_platform_cfg.h"
#include "hyun_first_eds_typedefs.h"
...
#define  HYUN_FIRST_MAJOR_VER   1
#define  HYUN_FIRST_MINOR_VER   0
...
#define CFG_HYUN_FIRST_CMD_TOPICID          HYUN_FIRST_CMD_TOPICID
#define CFG_HYUN_FIRST_SEND_STATUS_TOPICID  BC_SCH_4_SEC_TOPICID           // Use different CFG_ name instead of BC_SCH_4_SEC_TOPICID to localize impact if rate changes 
#define CFG_HYUN_FIRST_STATUS_TLM_TOPICID   HYUN_FIRST_STATUS_TLM_TOPICID
...
#define APP_CONFIG(XX) \
   ...
   XX(HYUN_FIRST_CMD_TOPICID,uint32) \
   XX(BC_SCH_4_SEC_TOPICID,uint32) \
   XX(HYUN_FIRST_STATUS_TLM_TOPICID,uint32) \
...
#define HYUN_FIRST_BASE_EID  (APP_C_FW_APP_BASE_EID +  0)

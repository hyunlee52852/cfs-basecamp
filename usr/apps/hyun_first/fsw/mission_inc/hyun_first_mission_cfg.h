...
**      compile time. Use hyun_first_platform_cfg.h for compile-time
...
**
*/
#ifndef _hyun_first_mission_cfg_
#define _hyun_first_mission_cfg_


#endif /* _hyun_first_mission_cfg_ */

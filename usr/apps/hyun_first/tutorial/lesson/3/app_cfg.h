...
#define CFG_HYUN_FIRST_SEND_HK_TOPICID  BC_SCH_4_SEC_TOPICID
#define CFG_HYUN_FIRST_HK_TLM_TOPICID   HYUN_FIRST_HK_TLM_TOPICID
...
#define APP_CONFIG(XX) \
   ...
   XX(HYUN_FIRST_HK_TLM_TOPICID,uint32) \
